...
const ProfilePage = () => {
    ...
    // form açma/kapatma kontrolü
    const [activeForm, setActiveForm] = useState(null); // "profile" | "password" | "delete" | null
        ...
        <div className="min-h-screen bg-gray-50 p-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
                <div className="flex border-b border-gray-200 mb-4">
                    ...
                    <button
                        className={`flex-1 py-2 text-center font-semibold ${activeTab === "favorites"
                                ? "border-b-4 border-blue-500 text-blue-500"
                                : "text-gray-500 hover:text-blue-500"
                            }`}
                ...
                <div>
                    {activeTab === "history" && <p>Buraya geçmiş rotaların listesi gelecek...</p>}
