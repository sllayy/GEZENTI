// PersonalizedSuggestionsCard.jsx dosyasındaki kod
// Butonların ve kartların stillerini güncelliyoruz.
            ...
            <div className="grid grid-cols-1 gap-4">
                ...
                <div className="border rounded-xl p-4 hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-500 mb-3">
                        ...
                        <div className="flex items-center">
                            <i className="pi pi-map-marker-alt mr-1 text-gray-400"></i>
                            <span>8 POI</span>
                        </div>
                    </div>
                    <Button
                        label="Rotayı Uygula"
                        className="
                             w-full py-2 px-4 rounded-full text-white font-semibold
                           bg-orange-500 hover:bg-orange-600ransition-colors duration-200 border-0
                        "
