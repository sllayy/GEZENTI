        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GirisUcreti = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    OrtalamaZiyaretSuresi = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RouteFeedbacks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrowdednessPreference = table.Column<int>(type: "integer", nullable: false),
                    MaxWalkDistance = table.Column<int>(type: "integer", nullable: false),
                    PreferredThemes = table.Column<string>(type: "text", nullable: true),
                    PreferredTransportationMode = table.Column<string>(type: "text", nullable: true),
                    MinStartTimeHour = table.Column<int>(type: "integer", nullable: false),
                    MaxEndTimeHour = table.Column<int>(type: "integer", nullable: false),
                    MinPoiRating = table.Column<double>(type: "double precision", nullable: false),
                    ConsiderTraffic = table.Column<bool>(type: "boolean", nullable: false),
                    PrioritizeShortestRoute = table.Column<bool>(type: "boolean", nullable: false),
                    AccessibilityFriendly = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
